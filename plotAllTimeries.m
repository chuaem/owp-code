...
for i = 1:length(site)
    ...
    % monthlyMean.(site{i}) = retime(dat,'monthly','mean');
    % monthlyStd.(site{i}) = retime(dat,'monthly',@std);
...
ax1 = nexttile;
errorbar(seasonal.North.mean_temperature,seasonal.North.std_temperature,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_temperature,seasonal.Gull.std_temperature,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_temperature,seasonal.South.std_temperature,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',[])
ylabel('T (^oC)')

ax2 = nexttile;
errorbar(seasonal.North.mean_pH,seasonal.North.std_pH,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_pH,seasonal.Gull.std_pH,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_pH,seasonal.South.std_pH,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
% ylim([7.4 8.6])
set(gca,'XTickLabel',[])
ylabel('pH')

ax3 = nexttile;
errorbar(seasonal.North.mean_DOsat,seasonal.North.std_DOsat,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_DOsat,seasonal.Gull.std_DOsat,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_DOsat,seasonal.South.std_DOsat,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',[])
ylabel('DO (%sat)')

ax4 = nexttile;
errorbar(seasonal.North.mean_salinity,seasonal.North.std_salinity,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr,'DisplayName','North')
hold on
errorbar(seasonal.Gull.mean_salinity,seasonal.Gull.std_salinity,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr,'DisplayName','Gull')
errorbar(seasonal.South.mean_salinity,seasonal.South.std_salinity,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr,'DisplayName','South')
set(gca,'XTickLabel',[])
ylabel('S (psu)')
legend('show','location','best')

ax5 = nexttile;
errorbar(seasonal.North.mean_chla,seasonal.North.std_chla,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_chla,seasonal.Gull.std_chla,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_chla,seasonal.South.std_chla,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',[])
ylabel('Chl a (RFU)')

ax6 = nexttile;
errorbar(seasonal.North.mean_turbidity,seasonal.North.std_turbidity,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_turbidity,seasonal.Gull.std_turbidity,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_turbidity,seasonal.South.std_turbidity,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',[])
ylabel('Turbidity (NTU)')

ax7 = nexttile;
errorbar(seasonal.North.mean_GPP,seasonal.North.std_GPP,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_GPP,seasonal.Gull.std_GPP,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_GPP,seasonal.South.std_GPP,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
hold on
errorbar(seasonal.North.mean_ER,seasonal.North.std_ER,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
errorbar(seasonal.Gull.mean_ER,seasonal.Gull.std_ER,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_ER,seasonal.South.std_ER,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',xaxisLbl)
ylabel('ER and GPP')
yline(0,'k','LineWidth',2)

ax8 = nexttile;
errorbar(seasonal.North.mean_NEM,seasonal.North.std_NEM,'o:','MarkerSize',12,'LineWidth',2,'Color',north_clr)
hold on
errorbar(seasonal.Gull.mean_NEM,seasonal.Gull.std_NEM,'o:','MarkerSize',12,'LineWidth',2,'Color',gull_clr)
errorbar(seasonal.South.mean_NEM,seasonal.South.std_NEM,'o:','MarkerSize',12,'LineWidth',2,'Color',south_clr)
set(gca,'XTickLabel',xaxisLbl)
ylabel('NEM')
yline(0,'k','LineWidth',2)
