...
figure(6),clf
yyaxis left;plot(dat.datetime_utc,dCdt,'.','markersize',6)
ylabel('dC/dt (mmol m^{-3} h^{-1})')
yyaxis right;plot(dat.datetime_utc,D,'.','markersize',6)
...
%%
cd([rootpath,'figures\diel-analysis-figures\Gull ERDC'])
