...
depths_flagged = struct('ind_dropout',ind_dropout,'ind_oow',ind_oow,'ind_grossRange',ind_grossRange,'ind_spike',ind_spike,'d_high',d_high,'d_low',d_low,'spike_threshold',spike_threshold);
...
% tiledlayout(2,1)
% ax1 = nexttile;
% h0 = plot(dat.datetime_utc,depth_orig,'.k');
% hold on
% xline([dat.datetime_utc(1); dat.datetime_utc(ind_dep+1)],'--',label);
% hold off
% ylabel('Depth')
% ylim([0 5])
% ax2 = nexttile;
% h1 = plot(dat.datetime_utc,T_orig,'.k');
% hold on
% xline([dat.datetime_utc(1); dat.datetime_utc(ind_dep+1)],'--',label);
% hold off
% ylabel('T')
...
T_flagged = struct('ind_dropout',ind_dropout,'ind_oow',ind_oow,'ind_grossRange',ind_grossRange,'ind_spike',ind_spike,'d_high',d_high,'d_low',d_low,'spike_threshold',spike_threshold);
...
histogram(d_DO)
title(['Spike Test Histogram: ',site,' ',sondename,' Sonde - DO Concentration'])
...
DOconc_flagged = struct('ind_dropout',ind_dropout,'ind_oow',ind_oow,'ind_grossRange',ind_grossRange,'ind_spike',ind_spike,'d_high',d_high,'d_low',d_low,'spike_threshold',spike_threshold);
...
%====(1) Gross Range Test==================================================
% INPUTS
S_low = 5;      % Lower limit (psu) - not sure what should be
...
title(['Spike Test Histogram: ',site,' ',sondename,' Sonde - Salinity'])
...
S_flagged = struct('ind_dropout',ind_dropout,'ind_oow',ind_oow,'ind_grossRange',ind_grossRange,'ind_spike',ind_spike,'S_high',S_high,'S_low',S_low,'spike_threshold',spike_threshold);
